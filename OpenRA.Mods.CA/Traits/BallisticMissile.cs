...
namespace OpenRA.Mods.CA.Traits
{
	...
	public class BallisticMissileCA : MissileBase
	{
		public BallisticMissileCA(ActorInitializer init, BallisticMissileCAInfo info)
			: base(init, info)
		{
			//
		}
		...
		{
			return new BallisticMissileCAFly(self, target, this);
		}
	}
}
