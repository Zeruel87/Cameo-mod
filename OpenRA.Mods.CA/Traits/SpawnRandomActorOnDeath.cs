...
namespace OpenRA.Mods.CA.Traits
{
	...
	public class SpawnRandomActorOnDeathInfo : ConditionalTraitInfo
	{
		...
		public override object Create(ActorInitializer init) { return new SpawnRandomActorOnDeath(init, this); }
	}
	...
	public class SpawnRandomActorOnDeath : ConditionalTrait<SpawnRandomActorOnDeathInfo>, INotifyKilled, INotifyRemovedFromWorld
	{
		...
		public SpawnRandomActorOnDeath(ActorInitializer init, SpawnRandomActorOnDeathInfo info)
			: base(info)
		{
		...
		void INotifyRemovedFromWorld.RemovedFromWorld(Actor self)
		{
			...
			var actor = Info.Actors.Random(world.SharedRandom);

			self.World.AddFrameEndTask(w => w.CreateActor(huskActor ?? actor, td));
		}
	}
}
