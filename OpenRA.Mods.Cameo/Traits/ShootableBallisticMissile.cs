...
namespace OpenRA.Mods.CA.Traits
{
	...
	public class ShootableBallisticMissileInfo : ITraitInfo, IMoveInfo, IFacingInfo, IOccupySpaceInfo, IPositionableInfo
	{
	...
	public class ShootableBallisticMissile : ITick, ISync, IFacing, IMove, IFirepowerModifier,
		INotifyCreated, INotifyAddedToWorld, INotifyRemovedFromWorld, INotifyActorDisposing, IOccupySpace, IPositionable
	{
		...
		public Activity MoveTo(CPos cell, Actor ignoreActor = null,
			bool evaluateNearestMovableCell = false, Color? targetLineColor = null)
		{
			return new ShootableBallisticMissileFly(self, Target.FromCell(self.World, cell));
		}
