...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class ProductionCAInfo : PausableConditionalTraitInfo
	{
		[FieldLoader.Require]
		[Desc("e.g. Infantry, Vehicles, Aircraft, Buildings")]
		public readonly string[] Produces = { };

		public override object Create(ActorInitializer init) { return new ProductionCA(init, this); }
	}

	public class ProductionCA : PausableConditionalTrait<ProductionCAInfo>, INotifyCreated
	{
