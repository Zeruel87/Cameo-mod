...
namespace OpenRA.Mods.Cameo.Traits.BotModules
{
	...
	public class SupportPowerBotModuleCAInfo : ConditionalTraitInfo, Requires<SupportPowerManagerInfo>
	{
		...
		public override object Create(ActorInitializer init) { return new SupportPowerBotModuleCA(init.Self, this); }
	}
	...
	public class SupportPowerBotModuleCA : ConditionalTrait<SupportPowerBotModuleCAInfo>, IBotTick, IGameSaveTraitData
	{
		...
		public SupportPowerBotModuleCA(Actor self, SupportPowerBotModuleCAInfo info)
			: base(info)
		{
			world = self.World;
			player = self.Owner;
