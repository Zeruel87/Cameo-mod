...
* Implied price change if the formula read effective HP: median **×1.394**, max **×1.789**
...
|---|---|--:|--:|--:|--:|--:|--:|
| redalert2mod_consortium | `steelconsortium_defenderbot` | 210,000 | 420,000 | 447,828 | ×2.132 | 3,200 | ×1.789 |
| redalert2mod_consortium | `steelconsortium_skyhammer` | 120,000 | 240,000 | 255,902 | ×2.132 | 4,500 | ×1.782 |
| redalert2mod_consortium | `steelconsortium_katytank` | 275,000 | 550,000 | 586,442 | ×2.132 | 3,800 | ×1.742 |
| redalert2mod_consortium | `steelconsortium_stalker` | 140,000 | 280,000 | 298,552 | ×2.132 | 4,000 | ×1.726 |
| redalert2mod_consortium | `steelconsortium_whiterabbit` | 150,000 | 300,000 | 319,878 | ×2.132 | 4,500 | ×1.591 |
| redalert2mod_consortium | `cruiser_f.steel` | 37,500 | 75,000 | 79,969 | ×2.132 | 125 | ×1.568 |
...
| starcraft_protoss | `protoss_epigraph` | 200,000 | 200,000 | 313,252 | ×1.566 | 2,600 | ×1.414 |
...
| starcraft_protoss | `protoss_idol` | 350,000 | 350,000 | 548,190 | ×1.566 | 2,800 | ×1.392 |
| starcraft_protoss | `protoss_arbiter` | 225,000 | 225,000 | 352,408 | ×1.566 | 4,800 | ×1.387 |
| starcraft_protoss | `protoss_atreus` | 250,000 | 250,000 | 391,565 | ×1.566 | 2,400 | ×1.385 |
| starcraft_protoss | `protoss_zeratul` | 250,000 | 250,000 | 391,565 | ×1.566 | 4,000 | ×1.381 |
| starcraft_protoss | `protoss_corsair` | 125,000 | 125,000 | 195,782 | ×1.566 | 2,100 | ×1.378 |
| redalert2mod_consortium | `steelconsortium_cloudbreaker` | 250,000 | 250,000 | 391,565 | ×1.566 | 5,000 | ×1.372 |
| redalert2mod_consortium | `cougar.steel` | 25,000 | 50,000 | 53,313 | ×2.132 | 1,200 | ×1.367 |
| starcraft_protoss | `protoss_reaver` | 275,000 | 275,000 | 430,721 | ×1.566 | 2,700 | ×1.356 |
| starcraft_protoss | `protoss_scout` | 75,000 | 75,000 | 117,469 | ×1.566 | 1,500 | ×1.330 |
...
| starcraft_protoss | `protoss_positron` | 60,000 | 60,000 | 93,976 | ×1.566 | 1,200 | ×1.276 |
...
| starcraft_protoss | `protoss_patriarch` | 75,000 | 75,000 | 117,469 | ×1.566 | 4,000 | ×1.248 |
...
| starcraft_protoss | `protoss_adept` | 30,000 | 30,000 | 46,988 | ×1.566 | 650 | ×1.134 |
| starcraft_protoss | `protoss_manifold` | 25,000 | 25,000 | 39,156 | ×1.566 | 600 | ×1.124 |
| starcraft_protoss | `protoss_photoncannon` | 200,000 | 200,000 | 313,252 | ×1.566 | 2,000 | ×1.010 |
